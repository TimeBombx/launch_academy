...
Defining this as a class method makes the functionality useful in more cases. Instance methods can call class methods, but class methods cannot call instance methods.
